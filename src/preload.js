...
contextBridge.exposeInMainWorld('codexer', {
  ...
  approveAgent: (approvalId, approved) => ipcRenderer.invoke('agent:approve', approvalId, approved),
  getWorkspace: () => ipcRenderer.invoke('workspace:get'),
  pickWorkspace: () => ipcRenderer.invoke('workspace:pick'),
  onAgentEvent: (callback) => ipcRenderer.on('agent:event', (_event, payload) => callback(payload)),
